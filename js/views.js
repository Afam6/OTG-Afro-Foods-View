...
var owlWrapperProducts = $('.tab-pane.active .owl-wrapper-products').children()
  .length

var trans = 0
$('.owl-prev#owl-p-specials').click(function () {
  owlWrapperProducts = $('#owl-specials').children().length
  transString = $('#owl-specials')[0]
...
$('.owl-prev.owl-buttons-tabs').click(function () {
  owlWrapperProducts = $('.tab-pane.active .owl-wrapper-products').children()
    .length
  transString = $('.tab-pane.active .owl-wrapper-products')[0]
    .style.transform.split('(')[1]
    .split('px')[0]
  trans = parseInt(transString)
...
$('.ttblog_prev').click(function () {
  ...
  var blogTransString = $('.owl-wrapper-blog')[0]
    .style.transform.split('(')[1]
    .split('px')[0]
...
$('.ttblog_next').click(function () {
  ...
  if (
    blogTrans ===
    owlItemBlogWidth * (owlWrapperBlogCount - blogSubtractor) * -1
  ) {
    blogTrans = 0
  } else {
    blogTrans -= owlItemBlogWidth
